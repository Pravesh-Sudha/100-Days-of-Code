...
Feeling excited to start Day 94 of 100 DaysOfCode, today, I dived deep into AWS and node, Golang and mongoDb by Creating a cloud native voting appliation with database on mongo, frontend on NodeJs and golang for APU and deploying it on a EKS cluster with help of [cloud champ]() in which he explained the whole process.
